...
class ApiService{
   ...
   Future addTodo(BuildContext context, String title) async {
     ...
     if (response.statusCode == 201) {
       var result = jsonDecode(response.body);
       TodoModel tm = TodoModel(id: result["id"], title: result["title"], isCompleted: result["completed"]);
   ...
   Future<bool> deleteTodo(int id, BuildContext context) async {
     String url = "https://eram-flutter-assessment-backend.onrender.com/todos/$id";
